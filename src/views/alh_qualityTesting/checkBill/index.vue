    ...
    <div class="filter-container">
      ...
      <el-form :inline="true" :model="listQuery" class="demo-form-inline">
        <el-form-item label="检验报告编号">
          <el-input v-model="listQuery.filter" placeholder="请输入检验报告编号" />
        </el-form-item>
        <el-form-item label="车间">
          <el-input v-model="listQuery.filter" placeholder="请输入车间" />
        </el-form-item>
        <el-form-item label="生产线">
          <el-input v-model="listQuery.filter" placeholder="请输入生产线" />
        </el-form-item>
        <el-form-item label="设备号">
          <el-input v-model="listQuery.filter" placeholder="请输入设备号" />
        </el-form-item>
      ...
      <el-table
        ...
        style="width: 100%"
      >
        <el-table-column label="检验报告编号" prop="index" align="center" min-width="50">
        ...
        <el-table-column label="生产线" prop="code" align="center">
          <template slot-scope="{ row }">
            <span>{{ '生产线' + row.index }}</span>
          </template>
        </el-table-column>
        <el-table-column label="设备号" prop="code" align="center">
          <template slot-scope="{ row }">
            <span>{{ row.code }}</span>
          </template>
        </el-table-column>
