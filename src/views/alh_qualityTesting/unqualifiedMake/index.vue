    ...
    <div class="filter-container">
      ...
      <el-form :inline="true" :model="listQuery" class="demo-form-inline">
        ...
        <el-form-item label="产品分类">
          <el-input v-model="listQuery.filter" placeholder="请输入产品分类" />
        </el-form-item>
        <el-form-item label="生产线">
          <el-input v-model="listQuery.filter" placeholder="请输入生产线" />
        </el-form-item>
        <el-form-item label="发生工段">
          <el-input v-model="listQuery.filter" placeholder="请输入发生工段" />
        </el-form-item>
      ...
      >
        ...
        <el-table-column label="产品分类" prop="code" align="center">
          <template slot-scope="{ row }">
        ...
        <el-table-column label="发生工段" prop="code" align="center">
          <template slot-scope="{ row }">
            <span>{{ '工段' + row.index }}</span>
          </template>
        </el-table-column>
