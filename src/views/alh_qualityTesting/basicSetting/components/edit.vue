  ...
  <div>
    <el-dialog :title="title" :visible.sync="visible" style="padding-bottom: 5vh" width="60%">
      <el-form ref="dataForm" :model="temp" label-position="left" label-width="auto" :rules="rules">
        <el-row>
          <el-col :span="12">
            <el-form-item label="料号" prop="customerCode">
              <el-input v-model="temp.customerCode" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="品名" prop="customerName">
              <el-input v-model="temp.customerName" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="物料分类" prop="dutyParagraph">
              <el-input v-model="temp.dutyParagraph" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="抽样方案" prop="dutyParagraph">
              <el-input v-model="temp.dutyParagraph" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="版本号" prop="dutyParagraph">
              <el-input v-model="temp.dutyParagraph" />
            </el-form-item>
          </el-col>
          <el-col :span="12">
            <el-form-item label="制单时间" prop="dutyParagraph">
              <el-input v-model="temp.dutyParagraph" />
            </el-form-item>
          </el-col>
