    ...
    <div class="filter-container">
      ...
      <el-form :inline="true" :model="listQuery" class="demo-form-inline">
        ...
        <el-form-item label="物料分类">
          <el-input v-model="listQuery.filter" placeholder="请输入物料分类" />
        </el-form-item>
      ...
      >
        ...
        <el-table-column label="抽样方案" prop="code" align="center">
          <template slot-scope="{ row }">
            <span>{{ '方案' + row.index }}</span>
          </template>
        </el-table-column>
        <el-table-column label="版本号" prop="code" align="center">
          <template slot-scope="{ row }">
            <span>{{ '版本' + row.index }}</span>
          </template>
        </el-table-column>
        <el-table-column label="制单时间" prop="code" align="center">
