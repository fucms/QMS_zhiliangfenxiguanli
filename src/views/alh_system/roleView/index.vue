    ...
    <div class="filter-container">
      ...
      <el-form :inline="true" :model="listQuery" class="demo-form-inline">
        <el-form-item label="角色">
          <el-input v-model="listQuery.filter" placeholder="请输入角色" />
        </el-form-item>
        <el-form-item label="权限">
          <el-input v-model="listQuery.filter" placeholder="请输入权限" />
        </el-form-item>
        <el-form-item>
      ...
      >
        ...
        <el-table-column label="角色" prop="code" align="center">
          <template slot-scope="{ row }">
            <span>{{ row.index%2 == 1 ? '管理员' : '普通用户' }}</span>
          </template>
        </el-table-column>
        <el-table-column label="权限" prop="code" align="center">
          <template slot-scope="{ row }">
            <span>{{ row.index%2 == 1 ? '增删改查' : '查询' }}</span>
          </template>
        </el-table-column>
